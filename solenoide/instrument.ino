...
/****** configuration ******/
const int startingNote = 60;  //F4# in my case
const bool wrapAround = true; //wrap around octaves. this will play notes that are too high or too low in your actave
const int malletCount = 16;   //total count of connected mallets
const int noteOffDelay = 50; //ms. make this high enough that the instrument works but low enough to be able to play fast notes
/*******************/
